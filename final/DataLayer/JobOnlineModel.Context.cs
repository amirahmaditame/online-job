...
public partial class OnlineJobEntities : DbContext
{
    ...
    public virtual ObjectResult<ReportEmployeeForPerForm_Result> ReportEmployeeForPerForm(Nullable<int> employeeid)
    {
    ...
    public virtual ObjectResult<FormForeachResume_Result> FormForeachResume(Nullable<int> resumeid)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<FormForeachResume_Result>("FormForeachResume", resumeidParameter);
    }
